...
# paths
path_sce = "results/correct-batches_experiment_1_2_untreated_human_embryo/sce.rds"
path_results = "results/correct-batches_experiment_1_2_untreated_human_embryo/cluster-cells"
...
names(palette_features$Cluster) <- 1:12
