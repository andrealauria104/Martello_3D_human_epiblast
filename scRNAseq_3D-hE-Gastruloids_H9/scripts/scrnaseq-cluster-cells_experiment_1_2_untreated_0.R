...
# paths
path_sce = "results/correct-batches_experiment_1_2_untreated_0/sce.rds"
path_results = "results/correct-batches_experiment_1_2_untreated_0/cluster-cells"
...
names(palette_features$ClusterLabels) <- c("A:PSCs","B:Transition1",
                                           "C:Transition2","D:Post.EpiLike",
                                           "E:Mes","F:Spont.Diff.2D")
