...
path_results = "results/correct-batches_experiment_1_2_untreated_0/cluster-cells/pseudotime-tscan"

if(!dir.exists(path_results)) dir.create(path_results, recursive = T)

# 0.1 Global params ----
metadata_features <- c("Time","Cluster") # used for grouping in plots, character vector

# clustering ---
cluster_feature_name = "Cluster" # Cluster
