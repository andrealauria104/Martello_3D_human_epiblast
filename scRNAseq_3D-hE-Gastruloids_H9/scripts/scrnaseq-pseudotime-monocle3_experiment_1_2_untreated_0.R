...
path_results = "results/correct-batches_experiment_1_2_untreated_0/cluster-cells/pseudotime-monocle3"
...
cds <- monocle3::order_cells(cds, root_pr_nodes = "Y_66") # Y_1 #Y_44
...
for(feature in metadata_features) {
  ...
  # pdf(file = outfile, paper = "a4r",w=unit(3,'cm'),h=unit(6,"cm"),useDingbats = F)
  # print(pumap_trajectory_l[[feature]])
  # dev.off()
}
